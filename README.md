About langchain-core-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/langchain-core-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/langchain-core-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add langchain-core
# for installing globally
pixi global install langchain-core
```
...
It is possible to list all of the versions of `langchain-core` available on your platform:
...
```
pixi search langchain-core --channel conda-forge
```
